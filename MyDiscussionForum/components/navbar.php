...
<body>
<nav class="navbar light-accent">
  <div class="navbar-left">
    <a href="index.html" class="nav-logo">MyDiscussionForum</a>
  </div>
  ...
  <div class="navbar-right">
    ...
    <button class="btn-secondary dropdown-toggle button-base primary-button" type="button" data-bs-toggle="dropdown" aria-expanded="false">
    ...
    <ul class="dropdown-menu dropdown-menu-end custom-dropdown">
      <li><button onClick="setTheme('light')" class="dropdown-item custom-dropdown">Light</button></li>
      <li><button onClick="setTheme('dark')" class="dropdown-item custom-dropdown">Dark</button></li>
    </ul>
    
    <div>
      <button class="btn-secondary dropdown-toggle button-base community-button" type="button" data-bs-toggle="dropdown" aria-expanded="false">
      ...
      <ul class="dropdown-menu dropdown-menu-end custom-dropdown" id="settings-dropdown">
...
<script src="./js/getUserAuthority.js"></script>
<script>
